...
(defn create-temp-config
  "Returns a config that refers to an clean temporary database, and a
  temporary vardir."
  ([] (create-temp-config (create-temp-db)))
  ([db-config]
   {:nrepl {}
...
(defn call-with-puppetdb-instance
  ...
  one will be generated by create-temp-config."
  ([f] (call-with-puppetdb-instance (create-temp-config) f))
