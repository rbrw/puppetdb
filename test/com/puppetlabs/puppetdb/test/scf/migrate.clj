...
(deftest migration-29
  (sql/with-connection db
    ...
    (letfn [(one-row [db]
      ...
      (legacy/add-facts-28! (facts-now "c-x" (random-facts)))
      (legacy/add-facts-28! (facts-now "c-y" (random-facts)))
      (legacy/add-facts-28! (facts-now "c-z" (random-facts)))
      ;; Check shapes.
      ...
      (legacy/add-facts-28! (facts-now "probe-values" {"foo-1" "bar"
                                                       "foo-2" "bar"}))
