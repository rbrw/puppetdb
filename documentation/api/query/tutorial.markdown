---
title: "PuppetDB 2.2 » API » Query Tutorial"
layout: default
canonical: "/puppetdb/latest/api/query/tutorial.html"
---

This page is a walkthrough for constructing several types of PuppetDB queries. It uses the **version 4 API** in all of its examples; however, most of the general principles are also applicable to the old API revisions.

If you need to use an older API, note that it lacks many of v4's capabilities, and be sure to consult that versions API endpoint references before attempting to use these examples with it.
